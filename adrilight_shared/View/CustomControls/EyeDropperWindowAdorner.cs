...
namespace adrilight_shared.View.CustomControls
{
    internal class EyeDropperWindowAdorner : Adorner
    {
        ...
        private static readonly Pen StrokePen = new Pen(Brushes.LightGray, 4);
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            // zoom view
            var rect = new Rect(15, 15, radius, radius);
            drawingContext.DrawRoundedRectangle(Brushes.White, StrokePen, rect,10,10);
            drawingContext.PushClip(new RectangleGeometry(rect,10,10));
