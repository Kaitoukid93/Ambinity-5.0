...
namespace adrilight.Services.NetworkStream
{
    ...
    public class WLEDDevice : INotifyPropertyChanged, IComparable
    {
        ...
        private string geometry = "powerLED";
        ...
        public double BrightnessCurrent {
            set
            {
                ...
                {
                    var toSend = (byte)Math.Round(brightnessCurrent);
        ...
        //public Color StateColor { get { return StateCurrent ? Color.From("#666") : Color.FromHex("#222"); } } //button background color
